...
def optforce(model, biomass, target, maximum_knockout, minimum_growth_fraction, minimum_target_fraction,
    ...
    # Find Must set
    excluded_reactions = [biomass,'ATPM'] + [r.id for r in model.reactions if r.boundary or not r.gene_reaction_rule]
